...
_tracetest2:     file format elf32-i386
...
{
  12:	51                   	push   %ecx
  13:	81 ec 84 00 00 00    	sub    $0x84,%esp
    int fd = open("README", O_RDONLY);
  19:	6a 00                	push   $0x0
  1b:	68 c8 07 00 00       	push   $0x7c8
  20:	e8 fe 02 00 00       	call   323 <open>
    read(fd, buf, 6);
  ...
  2c:	56                   	push   %esi
  2d:	50                   	push   %eax
  2e:	e8 c8 02 00 00       	call   2fb <read>
    trace();
  33:	e8 a3 03 00 00       	call   3db <trace>
    read(fd, buf, 7);
  38:	83 c4 0c             	add    $0xc,%esp
  3b:	6a 07                	push   $0x7
  3d:	56                   	push   %esi
  3e:	53                   	push   %ebx
  3f:	e8 b7 02 00 00       	call   2fb <read>
    int p = fork();
  44:	e8 92 02 00 00       	call   2db <fork>
    if (p == 0)
  49:	83 c4 10             	add    $0x10,%esp
  4c:	85 c0                	test   %eax,%eax
  4e:	75 29                	jne    79 <main+0x79>
    {
        read(fd, buf, 8);
  50:	50                   	push   %eax
  51:	6a 08                	push   $0x8
  53:	56                   	push   %esi
  54:	53                   	push   %ebx
  55:	e8 a1 02 00 00       	call   2fb <read>
        int fd1 = open("cs333.txt", O_RDONLY);
  5a:	5a                   	pop    %edx
  5b:	59                   	pop    %ecx
  5c:	6a 00                	push   $0x0
  5e:	68 cf 07 00 00       	push   $0x7cf
  63:	e8 bb 02 00 00       	call   323 <open>
        read(fd1, buf, 100);
  68:	83 c4 0c             	add    $0xc,%esp
  6b:	6a 64                	push   $0x64
  6d:	56                   	push   %esi
  6e:	50                   	push   %eax
  6f:	e8 87 02 00 00       	call   2fb <read>
        exit();
 ...
 641:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 e8 0a 00 00    	mov    %edx,0xae8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
