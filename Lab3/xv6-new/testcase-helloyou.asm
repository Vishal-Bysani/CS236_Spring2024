...
_testcase-helloyou:     file format elf32-i386
...
int main(void)
{
  ...
  25:	c7 04 24 89 07 00 00 	movl   $0x789,(%esp)
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 a0 07 00 00 	jmp    *0x7a0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 98 07 00 00       	mov    $0x798,%edx
        while(*s != 0){
