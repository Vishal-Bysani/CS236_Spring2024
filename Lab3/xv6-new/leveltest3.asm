...
_leveltest3:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  3c:	75 2b                	jne    69 <main+0x69>
    {
        level = getLevel(getpid());
  3e:	e8 20 03 00 00       	call   363 <getpid>
  ...
  46:	50                   	push   %eax
    else
    {
        ...
        {
            level = getLevel(100);
  47:	e8 87 03 00 00       	call   3d3 <getLevel>
  4c:	89 c3                	mov    %eax,%ebx
            printf(2, "child level- %d with pid %d\n", level, getpid());
  4e:	e8 10 03 00 00       	call   363 <getpid>
  53:	50                   	push   %eax
  54:	53                   	push   %ebx
  55:	68 d6 07 00 00       	push   $0x7d6
  5a:	6a 02                	push   $0x2
  ...
  64:	e8 7a 02 00 00       	call   2e3 <exit>
        int c2 = fork();
  69:	e8 6d 02 00 00       	call   2db <fork>
        if (c2 == 0)
  6e:	85 c0                	test   %eax,%eax
  70:	75 07                	jne    79 <main+0x79>
            level = getLevel(100);
  72:	83 ec 0c             	sub    $0xc,%esp
  75:	6a 64                	push   $0x64
  77:	eb ce                	jmp    47 <main+0x47>
        }
        wait();
  79:	e8 6d 02 00 00       	call   2eb <wait>
        wait();
  7e:	e8 68 02 00 00       	call   2eb <wait>
    }
