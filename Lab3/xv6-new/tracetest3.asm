...
_tracetest3:     file format elf32-i386
...
main(int argc, char *argv[]) {
  12:	51                   	push   %ecx
  13:	83 ec 34             	sub    $0x34,%esp
    int fd = open("README", O_RDONLY);
  16:	6a 00                	push   $0x0
  18:	68 c8 07 00 00       	push   $0x7c8
  1d:	e8 01 03 00 00       	call   323 <open>
    read(fd, buf, 6);    
  ...
  29:	56                   	push   %esi
  2a:	50                   	push   %eax
  2b:	e8 cb 02 00 00       	call   2fb <read>
    read(fd, buf, 7);
  30:	83 c4 0c             	add    $0xc,%esp
  33:	6a 07                	push   $0x7
  35:	56                   	push   %esi
  36:	53                   	push   %ebx
  37:	e8 bf 02 00 00       	call   2fb <read>
    int p = fork();
  3c:	e8 9a 02 00 00       	call   2db <fork>
    if (p == 0)
  41:	83 c4 10             	add    $0x10,%esp
  44:	85 c0                	test   %eax,%eax
  46:	75 38                	jne    80 <main+0x80>
    {
        trace();
  48:	e8 8e 03 00 00       	call   3db <trace>
        read(fd, buf, 8);
  4d:	52                   	push   %edx
  4e:	6a 08                	push   $0x8
  50:	56                   	push   %esi
  51:	53                   	push   %ebx
  52:	e8 a4 02 00 00       	call   2fb <read>
        int p2 = fork();
  57:	e8 7f 02 00 00       	call   2db <fork>
        if (p2 == 0)
  5c:	83 c4 10             	add    $0x10,%esp
  5f:	85 c0                	test   %eax,%eax
  61:	75 1d                	jne    80 <main+0x80>
        {
            // The program being exec'd might call read multiple times
            exec("wc", arg);
  63:	50                   	push   %eax
  64:	50                   	push   %eax
  65:	68 e4 0a 00 00       	push   $0xae4
  6a:	68 cf 07 00 00       	push   $0x7cf
  6f:	e8 a7 02 00 00       	call   31b <exec>
            exit();
  ...
  79:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            ...
            wait();
  80:	e8 66 02 00 00       	call   2eb <wait>
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 dc 07 00 00 	jmp    *0x7dc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba d2 07 00 00       	mov    $0x7d2,%edx
        while(*s != 0){
 ...
 641:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 ec 0a 00 00    	mov    %edx,0xaec
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 ec 0a 00 00    	mov    %edx,0xaec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 ec 0a 00 00    	mov    %edx,0xaec
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 ec 0a 00 00 f0 	movl   $0xaf0,0xaec
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf f0 0a 00 00       	mov    $0xaf0,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
