...
_leveltest2:     file format elf32-i386
...
main(int argc, char *argv[]) {
   ...
   f:	e8 af 03 00 00       	call   3c3 <getpid>
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	50                   	push   %eax
  18:	e8 16 04 00 00       	call   433 <getLevel>
  1d:	89 c3                	mov    %eax,%ebx
    printf(2, "parent level- %d with pid %d\n", level, getpid());
  1f:	e8 9f 03 00 00       	call   3c3 <getpid>
  24:	50                   	push   %eax
  25:	53                   	push   %ebx
  26:	68 18 08 00 00       	push   $0x818
  2b:	6a 02                	push   $0x2
  2d:	e8 be 04 00 00       	call   4f0 <printf>

    int c1 = fork();
  32:	83 c4 20             	add    $0x20,%esp
  35:	e8 01 03 00 00       	call   33b <fork>
    if (c1 == 0)
  3a:	85 c0                	test   %eax,%eax
  3c:	0f 85 86 00 00 00    	jne    c8 <main+0xc8>
    {
        level = getLevel(getpid());
  42:	e8 7c 03 00 00       	call   3c3 <getpid>
  47:	83 ec 0c             	sub    $0xc,%esp
  4a:	50                   	push   %eax
  4b:	e8 e3 03 00 00       	call   433 <getLevel>
  50:	89 c3                	mov    %eax,%ebx
        printf(2, "child level - %d with pid %d\n", level, getpid());
  52:	e8 6c 03 00 00       	call   3c3 <getpid>
  57:	50                   	push   %eax
  58:	53                   	push   %ebx
  59:	68 36 08 00 00       	push   $0x836
  5e:	6a 02                	push   $0x2
  60:	e8 8b 04 00 00       	call   4f0 <printf>
        int c2 = fork();
  65:	83 c4 20             	add    $0x20,%esp
  68:	e8 ce 02 00 00       	call   33b <fork>
        if (c2 == 0)
  6d:	85 c0                	test   %eax,%eax
  6f:	75 6b                	jne    dc <main+0xdc>
        {
            level = getLevel(getpid());
  71:	e8 4d 03 00 00       	call   3c3 <getpid>
  76:	83 ec 0c             	sub    $0xc,%esp
  79:	50                   	push   %eax
  7a:	e8 b4 03 00 00       	call   433 <getLevel>
  7f:	89 c3                	mov    %eax,%ebx
            printf(2, "grand child level before orphan - %d with pid %d\n", level, getpid());
  81:	e8 3d 03 00 00       	call   3c3 <getpid>
  86:	50                   	push   %eax
  87:	53                   	push   %ebx
  88:	68 54 08 00 00       	push   $0x854
  8d:	6a 02                	push   $0x2
  8f:	e8 5c 04 00 00       	call   4f0 <printf>

            sleep(3);
  94:	83 c4 14             	add    $0x14,%esp
  97:	6a 03                	push   $0x3
  99:	e8 35 03 00 00       	call   3d3 <sleep>
            level = getLevel(getpid());
  9e:	e8 20 03 00 00       	call   3c3 <getpid>
  a3:	89 04 24             	mov    %eax,(%esp)
  a6:	e8 88 03 00 00       	call   433 <getLevel>
  ab:	89 c3                	mov    %eax,%ebx
            printf(2, "grand child level after orphan - %d with pid %d\n", level, getpid());
  ad:	e8 11 03 00 00       	call   3c3 <getpid>
  b2:	50                   	push   %eax
  b3:	53                   	push   %ebx
  ...
  c3:	e8 7b 02 00 00       	call   343 <exit>
        ...
        wait();
  c8:	e8 7e 02 00 00       	call   34b <wait>

    sleep(4);
  cd:	83 ec 0c             	sub    $0xc,%esp
  d0:	6a 04                	push   $0x4
  d2:	e8 fc 02 00 00       	call   3d3 <sleep>
    exit();
  d7:	e8 67 02 00 00       	call   343 <exit>
            sleep(1);
  dc:	83 ec 0c             	sub    $0xc,%esp
  df:	6a 01                	push   $0x1
  e1:	e8 ed 02 00 00       	call   3d3 <sleep>
        exit();
  e6:	e8 58 02 00 00       	call   343 <exit>
  eb:	66 90                	xchg   %ax,%ax
  ed:	66 90                	xchg   %ax,%ax
  ef:	90                   	nop
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 c0 08 00 00 	jmp    *0x8c0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba b9 08 00 00       	mov    $0x8b9,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 c4 0b 00 00       	mov    0xbc4,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 c4 0b 00 00    	mov    0xbc4,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 c4 0b 00 00 c8 	movl   $0xbc8,0xbc4
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf c8 0b 00 00       	mov    $0xbc8,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 c8 0b 00 00 c8 	movl   $0xbc8,0xbc8
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 cc 0b 00 00 00 	movl   $0x0,0xbcc
 802:	00 00 00 
    if(p->s.size >= nunits){
