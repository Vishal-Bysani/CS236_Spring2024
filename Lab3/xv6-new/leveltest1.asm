...
_leveltest1:     file format elf32-i386
...
main(int argc, char *argv[]) {
  ...
  17:	50                   	push   %eax
  18:	e8 b6 03 00 00       	call   3d3 <getLevel>
  1d:	89 c3                	mov    %eax,%ebx
    printf(2, "parent level- %d with pid %d\n", level, getpid());
  1f:	e8 3f 03 00 00       	call   363 <getpid>
  24:	50                   	push   %eax
  25:	53                   	push   %ebx
  26:	68 b8 07 00 00       	push   $0x7b8
  2b:	6a 02                	push   $0x2
  2d:	e8 5e 04 00 00       	call   490 <printf>

    int c1 = fork();
  32:	83 c4 20             	add    $0x20,%esp
  35:	e8 a1 02 00 00       	call   2db <fork>
    if (c1 == 0)
  3a:	85 c0                	test   %eax,%eax
  3c:	74 09                	je     47 <main+0x47>
        ...
        int c2 = fork();
  3e:	e8 98 02 00 00       	call   2db <fork>
        if (c2 == 0)
  43:	85 c0                	test   %eax,%eax
  45:	75 2b                	jne    72 <main+0x72>
        {
            level = getLevel(getpid());
  47:	e8 17 03 00 00       	call   363 <getpid>
  4c:	83 ec 0c             	sub    $0xc,%esp
  4f:	50                   	push   %eax
  50:	e8 7e 03 00 00       	call   3d3 <getLevel>
  55:	89 c3                	mov    %eax,%ebx
            printf(2, "child level- %d with pid %d\n", level, getpid());
  57:	e8 07 03 00 00       	call   363 <getpid>
  5c:	50                   	push   %eax
  5d:	53                   	push   %ebx
  5e:	68 d6 07 00 00       	push   $0x7d6
  63:	6a 02                	push   $0x2
  ...
  6d:	e8 71 02 00 00       	call   2e3 <exit>
        ...
        wait();
  72:	e8 74 02 00 00       	call   2eb <wait>
        wait();
  77:	e8 6f 02 00 00       	call   2eb <wait>
    }
        
    exit();
  7c:	e8 62 02 00 00       	call   2e3 <exit>
  81:	66 90                	xchg   %ax,%ax
  83:	66 90                	xchg   %ax,%ax
  85:	66 90                	xchg   %ax,%ax
  87:	66 90                	xchg   %ax,%ax
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 fc 07 00 00 	jmp    *0x7fc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba f3 07 00 00       	mov    $0x7f3,%edx
        while(*s != 0){
 ...
 631:	a1 00 0b 00 00       	mov    0xb00,%eax
{
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 00 0b 00 00    	mov    %edx,0xb00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 00 0b 00 00    	mov    0xb00,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 00 0b 00 00    	mov    %edx,0xb00
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 00 0b 00 00 04 	movl   $0xb04,0xb00
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 04 0b 00 00       	mov    $0xb04,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 7a2:	00 00 00 
    if(p->s.size >= nunits){
