...
_tracetest1:     file format elf32-i386
...
main(int argc, char *argv[]) {
  ...
  1d:	e8 d1 02 00 00       	call   2f3 <open>
    read(fd, buf, 5);
  ...
  29:	56                   	push   %esi
  2a:	50                   	push   %eax
  2b:	e8 9b 02 00 00       	call   2cb <read>
    trace();
  30:	e8 76 03 00 00       	call   3ab <trace>
    read(fd, buf, 5);
  35:	83 c4 0c             	add    $0xc,%esp
  38:	6a 05                	push   $0x5
  3a:	56                   	push   %esi
  3b:	53                   	push   %ebx
  3c:	e8 8a 02 00 00       	call   2cb <read>
    read(fd, buf, 5);
  41:	83 c4 0c             	add    $0xc,%esp
  44:	6a 05                	push   $0x5
  46:	56                   	push   %esi
  47:	53                   	push   %ebx
  48:	e8 7e 02 00 00       	call   2cb <read>

    exit();
  4d:	e8 61 02 00 00       	call   2b3 <exit>
  52:	66 90                	xchg   %ax,%ax
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba 9f 07 00 00       	mov    $0x79f,%edx
        while(*s != 0){
